...
class Serializer
{
     ...
     * @throws ConfigurationException
     */
    public function isAutoGeneratedId(string $alias): bool
    {
        return $this->configStore->getEntityConfigByAlias($alias)->isAutoGeneratedId();
    }
    ...
    {
        if ($config->getPrimaryAttribute()->getter !== null) {
